        ...
        window.graficoBarras = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: ['rgb(13, 105, 15)', 'rgb(105, 13, 13)'],
                    borderRadius: 20,
                    borderWidth: 3
                }]
            },
    ...
    try {
        ...
        graficoPizza = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: valores,
                    backgroundColor: ['rgb(168, 0, 0)', 'rgb(242, 218, 1)', 'rgb(0, 6, 179)', 'rgb(221, 0, 166)', 'rgb(143, 0, 195)', 'rgb(240, 132, 0)', 'rgb(0, 154, 3)'],
                    borderColor: '#000000',        
                    borderWidth: 0,               
        ...
        graficoLinha = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Gastos (R$)',
                    data: valores,
                    borderColor: 'rgb(105, 13, 13)',
                    backgroundColor: 'rgba(244, 0, 0, 0.27)',
                    tension: 0.4,
                    fill: true
                }]
            },
